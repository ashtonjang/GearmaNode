...
var winston = require('winston'), version = require('./gearmanode/version'), job     = require('./gearmanode/job'), Client  = require('./gearmanode/client').Client, Worker  = require('./gearmanode/worker').Worker;
 ...
 */
winston.createLogger().constructor.prototype.isLevelEnabled = function(level) {
